...
public class Monishadapter extends RecyclerView.Adapter<Monishadapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            productname = (TextView) view.findViewById(R.id.textView);
            productprices=(TextView) view.findViewById(R.id.textView1);
            productimagess=(ImageView) view.findViewById(R.id.imageView);
        }
    }
